...
function comesbebes_enqueue_style(){
    ...
    wp_register_style('comesbebes-comic-neue-font', 'https://fonts.googleapis.com/css2?family=Comic+Neue:wght@400;700&display=swap');
    ...
    wp_enqueue_style('comesbebes-comic-neue-font');
